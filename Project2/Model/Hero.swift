   ...
   static func fetchHeroes() -> Promise<[Hero]> {
                    ...
                    if temp_dict.keys.contains("contentList") {
                        ...
                        for i in 0..<hero_content.count {
                            ...
                            let post = Post(albumArtImage: (hero_content["Post\(i + 1)"]?["albumArtImage"] as! String) ,
                                            ...
                                            helper_preview_url: (hero_content["Post\(i + 1)"]?["helper_preview_url"] as! String),
        ...
        self.fetchHeroes().done { heroes in
            ...
            for i in 0..<hero_list!.count {
                ...
                for j in 0..<hero_list![i].contentList!.count {
                    ...
                    post_dict.updateValue(hero_list![i].contentList?["Post\(j+1)"]?.helper_preview_url, forKey: "helper_preview_url")
    ...
    static func add_new_hero_to_firebase (new_hero: Hero, new_hero_number: Int) {
        ...
        for j in 0..<new_hero.contentList!.count {
            ...
            post_dict.updateValue(new_hero.contentList?["Post\(j+1)"]?.helper_preview_url, forKey: "helper_preview_url")
    ...
    static func push_new_content_list_to_firebase (hero_key: String, content_list: [String : Post]) {
        ...
        for j in 0..<content_list.count {
            ...
            post_dict.updateValue(content_list["Post\(j+1)"]?.helper_preview_url, forKey: "helper_preview_url")
