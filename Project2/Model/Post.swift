    ...
    static func dict_posts () {
        ...
        self.fetchPosts().done { posts in
            ...
            for i in 0..<post_list!.count {
                ...
                post_dict.updateValue(post_list![i].GIF_url, forKey: "GIF_url")
...
//            })
    ...
    static func dict_posts_for_profile () {
        ...
        self.fetchPosts().done { posts in
            ...
            for i in 0..<post_list!.count {
                ...
                ref.child("user_db").child("profile_db").child("profile_post_db").updateChildValues(final_post) { (err, ref) in
    ...
    static func add_new_post_to_profile (new_post: Post, new_post_number: Int) {
    ...
    static func delete_a_post_from_profile () {
