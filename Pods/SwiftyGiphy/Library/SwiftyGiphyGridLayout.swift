...
public class SwiftyGiphyGridLayout: UICollectionViewLayout {
    ...
    public var delegate: SwiftyGiphyGridLayoutDelegate?
    ...
    override public func prepare() {
        ...
        if cellAttributeCache.isEmpty
        {
            ...
            for item in 0..<collectionView!.numberOfItems(inSection: 0)
            {
                ...
                //print ("cell height collected from delegate is \(cellHeight)")
    ...
    override public var collectionViewContentSize: CGSize {
        //print ("Content Size being collected from collection view")
